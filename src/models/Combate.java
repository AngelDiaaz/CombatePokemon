			...
			do {
				...
				if (movimiento < 4) { // Para realizar un movimiento
					...
					if (movimiento < 4) {
						...
						System.out.println(
								pokemon4.getNombre() + " uso " + pokemon4.movimiento.get(movimiento).getNombre());
						...
						if (!es) {
							System.out.println(
									entrenador1.getNombre() + " selecciona el pokemon que quieres que luche ahora");
							pokemon4 = entrenador1.elegirPokemon();
						} else {
							System.out.println(
									entrenador2.getNombre() + " selecciona el pokemon que quieres que luche ahora");
